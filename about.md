...
<div class="page-shell">
  ...
  <p>
    ...
    custom wheelchair work surfaces to designing assistive pen holders and soft
    robotic concepts. I love moving between big-picture systems thinking and
  ...
  <div class="pill-card pill-card--purple">
    ...
    <p>
      Experience taking ideas from sketches to functional prototypes using
      CAD, rapid prototyping, and iterative testing.
    </p>
  </div>
